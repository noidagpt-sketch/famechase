...
const languages = {
  ...
  hindi: {
    ...
    whatYouGet: "भु��तान करने के बाद आपको मिलेगा:",
...
🏆 ${language === "hindi" ? "��ेम स्कोर रिपोर्ट" : "FAME SCORE REPORT"} - ${userName}
════════════════════════════════════════���════════════════
...
${language === "hindi" ? "📱 प्राथ��िक प्लेटफॉर्म:" : "📱 Primary Platform:"} ${quizData.primaryPlatform}
...
${language === "hindi" ? "📊 रियल-टाइम मर्केट एनलिसिस रिपोर्ट" : "📊 REAL-TIME MARKET ANALYSIS REPORT"}
══════════════════════���════════════════════════════

${language === "hindi" ? "👤 आकी प्रोफाइल:" : "👤 YOUR PROFILE:"}
${language === "hindi" ? "फॉलोअरस:" : "Followers:"} ${quizData.followerCount} (${followerNum.toLocaleString()} actual)
${language === "hindi" ? "निच:" : "Niche:"} ${quizData.niche}
${language === "hindi" ? "प्लेटफॉर्म:" : "Platform:"} ${quizData.primaryPlatform}
...
3. ${language === "hindi" ? "लॉ���्ग-टर्म कैंपेन्स के लिए 25% डिस्काउंट ऑफर करें" : "Offer 25% package discount for 3+ month campaigns"}
...
${language === "hindi" ? "टारगेट फॉलोअ्स (30 दिन):" : "Target Followers (30 days):"} ${projectedFollowers.toLocaleString()}
...
│ ${language === "hindi" ? "पोस्ट रीच" : "Post Reach"}: _______ (टागेट: ${estimatedReach.toLocaleString()})     │
...
${language === "hindi" ? "⚡ एड��ांस्ड एंगेजमेंट कैलकुलेशन:" : "⚡ ADVANCED ENGAGEMENT CALCULATION:"}
...
│ ${language === "hindi" ? "डीलस क्लोज्ड" : "Deals Closed"}: _____ (टारगेट: 15%)      │
...
4. ${language === "hindi" ? "पहले 30 मिनट में जयादा likes = Algorithm boost" : "High likes in first 30 minutes = Algorithm boost"}
...
□ ${language === "hindi" ? "हैशटै��� परफॉर्मेंस चेक करें और underperforming को replace करें" : "Check hashtag performance and replace underperforming ones"}
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="bg-gradient-to-r from-purple-50 to-blue-50 border-2 border-purple-200 rounded-2xl p-8 mb-8">
              ...
              <h2 className="text-2xl font-bold text-gray-900 mb-4">
                {language === "hindi"
                  ? "💰 मोनटाइज़ेशन प्रो टूल्स - अभी कमाना शुरू रं!"
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-6">
                <div className="bg-white rounded-xl p-6 border border-purple-200">
                  ...
                  <p className="text-gray-600 text-sm mb-4">
                    {language === "hindi"
                      ? "जानें कि आप र महीने कतन कमा कते हैं। टॉप क्रिएटरस के डेटा पर आधरित 95% सटीक कैकुलेशन।"
                ...
                <div className="bg-white rounded-xl p-6 border border-purple-200">
                  ...
                  <p className="text-gray-600 text-sm mb-4">
                    {language === "hindi"
                      ? "वही ट्रैकिंग सिस्टम जो मिलियन-फॉलोअर क्रिएटर्स इस्ेमाल क���े हैं। अपनी ROI को 300% तक बढ़ाए।"
            ...
            <div className="bg-gradient-to-r from-purple-50 to-pink-50 border-2 border-purple-200 rounded-2xl p-8 mb-8">
              ...
              <p className="text-gray-600 mb-6">
                {language === "hindi"
                  ? "आपके quiz responses के आधर पर, हमारे AI ने ये specific tools recommend किए हैं जो आपकी exact needs जो पूरा करेंगे।"
          ...
          <div className="text-center mb-8 relative overflow-hidden">
            ...
            <div className="relative">
              ...
              <div className="bg-gradient-to-r from-purple-600 via-pink-600 to-red-600 bg-clip-text text-transparent text-2xl font-bold mb-2">
                🎉{" "}
                {language === "hindi"
                  ? "बधाई हो! आपका विश्ले��ण तैयार है!"
                              ...
                              {!challenge.includes("Low views") &&
                                ...
                                !challenge.includes("collaborations") && (
                                  <>
                                    ...
                                    <p>
                                      {language === "hindi"
                                        ? " Specific action plan बाएं इस challenge के लिए"
              ...
              <div className="bg-white rounded-xl p-5 border border-gray-200">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <div className="text-lg font-bold text-green-600">
                    ...
                    quizData.monthlyIncome === "0 (अ��ी तक को आय नहीं)"
                      ? "🔴"
                      : "🟢"}
                  </div>
                </div>
