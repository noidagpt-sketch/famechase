...
const translations = {
  ...
  hindi: {
    ...
    whatYouGet: {
      ...
      deliverables: {
        fameScore: {
          ...
          description:
            "आपके कंटेंट, ऑडियंस, और विक���स क्षमता का AI-powered विश्लेषण ज���समें कार्यशील सुझाव हैं।",
      ...
      steps: [
        {
          ...
          description:
            "अपने कंटेंट, ऑडियंस, लक्ष्यों और वर्तमान चुनौतियों के बारे में प्रश्नों के उत्तर दें। हमारा AI सब कुछ विश्लेषित करता ���ै।",
        },
        {
          number: "2",
    ...
    finalCta: {
      ...
      subtitle:
        "हजारों क्रिएटर्स से जुड़ें जिन्होंने हमारे सिद्ध फ��रेमवर्क का उपयोग करके सफल व्यवसाय बनाए हैं",
      cta: "अपना ��ुफ्त क्रिएटर किट अभी प���राप्त करें",
      benefits: [
...
हमारा मिशन सभी स्तरों के क्रिएटर्स के लिए इन्फ्लुएंसर सफलता को सुलभ, रणनीतिक, और लाभदायक बनाना है।`,
    ...
    contact: {
      title: "📬 संपर्क करें",
      content: `को�� प्रश्न, फीडबैक, या पार्टनरशिप पूछताछ है? हम मदद के लिए यहाँ हैं!
...
• डिवाइस और उपयोग डेटा (कुकीज़ य�� एनालिटिक्स टूल्स के माध्यम से)
...
आप mail@famechase.com पर ईमेल करके किसी भी समय अपने डेटा को हटाने या सुधार��े का अनुरोध कर सक���े हैं।`,
    },
    terms: {
