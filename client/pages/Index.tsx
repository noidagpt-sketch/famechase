...
const translations = {
  ...
  hindi: {
    ...
    whatYouGet: {
      ...
      subtitle:
        "अपना क्विज़ पूरा करें और ₹10,000+ मूल्य के प्रोफेशनल टूल्स ���क बिल्कुल मुफ्त तुरंत पहुँच प्राप्त करें",
      deliverables: {
        fameScore: {
    ...
    successStories: {
      ...
      stories: [
        ...
        },
        {
          ...
          avatar: "वि",
          testimonial:
            "ग्रोथ स्ट्र��टेजी ने मुझे अपने ऑडियंस को बेहतर समझने में मदद की। मैंने इनसाइट्स का उपयोग करके कंटेंट को ऑप्टिमाइज़ किया और 4 महीने में 5K से 25K फॉलोअर्स तक पहुँचा।",
...
हम कभी भी आपका डेटा तीसरे पक्ष को नहीं बेचते या साझा नहीं करते। सभी जानकारी सुरक्षित रूप से स���ग्रहीत की जाती है और केवल सेवा वितरण और सुधार के लिए उपयोग की जाती है।
...
2. भुगतान और रिफंड:
सभी खरीदारी अंतिम हैं। चूंकि हमारे उत्पाद डिजिटल हैं और ��ुरंत वितरित किए जाते हैं, हम रिफंड की पेशकश नहीं करते।
