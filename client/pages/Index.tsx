...
const translations = {
  ...
  hindi: {
    ...
    whatYouGet: {
      ...
      deliverables: {
        fameScore: {
          ...
          description:
            "आपके कंटेंट, ऑडियंस, और विकास क्षमता का AI-powered विश्ल��षण जिसमें कार्यशील सुझाव हैं।",
      ...
      premiumUpgrade: {
        ...
        subtitle:
          "अपने ���ंटेंट को लाभदायक व्यवसाय में बदलने के लिए आवश्यक सब कुछ",
        features: [
          "30+ ईमेल टेम्प्लेट्स",
          "लाइव प्रोफाइल पेज",
          "एनालिटिक्स डैशबोर्ड",
    ...
    successStories: {
      ...
      subtitle: "असली क्रिएटर्स, असली परिणाम, असली आय व��द्धि",
      stories: [
        {
          name: "अन���्या शर्मा",
          role: "ब्यूटी क्रिएटर",
    ...
    finalCta: {
      ...
      cta: "अपना मुफ्त क���रिएटर किट अभी प्राप्त करें",
      benefits: [
...
हम कभी भी आपका डेटा तीसरे पक्ष को न���ीं बेचते या साझा नहीं करते। सभी जानकारी सुरक्षित रूप से स���ग्रहीत की जाती ��ै और केवल सेवा वितरण और सुधार के लिए उपयोग की जाती है।
...
यदि आपसे ��लती से शुल्क लिया गया है या बिलिंग संबंधी कोई चिंता है, तो 7 दिनों के भीतर mail@famechase.com पर ईमेल करें — हम मामले-दर-मामला स���ीक्षा करेंगे।`,
    },
  },
};
