...
const translations = {
  ...
  hindi: {
    ...
    hero: {
      ...
      subtitle:
        "केवल 3 मिनट में अपना व्यक्तिगत क्रिएटर ग्रोथ किट, प्रोफेशनल मीडिया किट, और AI-पावर्�� रणनीति प्राप्त करें।",
      proofPoints: [
        "100% मुफ्त विश्लेषण",
        "तुरंत डाउनलोड",
        "असली बिज़नेस टूल्स",
    ...
    whatYouGet: {
      ...
      deliverables: {
        fameScore: {
          ...
          description:
            "आपके कंटेंट, ऑ���ियंस, और विक���स क्षमता का AI-powered विश्लेषण जिसमें कार्यशील सुझाव हैं।",
    ...
    successStories: {
      ...
      stories: [
        ...
        },
        {
          ...
          avatar: "वि",
          testimonial:
            "ग्रोथ स्ट्रैटेजी ने मुझे अपने ऑडियंस को बेहतर समझ��े में मदद की। मैं���े इनसाइट्स का उपयोग करके कंटेंट को ऑप्टिमाइज़ किया और 4 महीने में 5K से 25K फॉलोअर्�� तक पहुँचा।",
    ...
    finalCta: {
      ...
      subtitle:
        "हजारों क्��िएटर्स से जुड़ें जिन्होंने हमारे सिद्ध फ्रेमवर्क का उपयोग करके सफल व्यवसाय बन���ए हैं",
...
• व्यक्तिगत परिणाम उत्पन्न करने के लिए क्विज़ प्रत��क्रियाएं
...
आप mail@famechase.com पर ईमेल करके किसी भी समय अपन��� डेटा को हटाने या सुधार��े का अनुरोध कर सकते हैं।`,
    },
    terms: {
...
3. बौद्धिक संपदा:
प्रदान की गई सभी सामग्री, डिज़ाइन, औ�� टूल्स FameChase की बौद्धिक संपदा हैं। अनधिकृत उपयोग निषिद्ध है।
...
export default function Index() {
  ...
  const safeCopy = sanitizeDeep(copy[language]);
  const t = safeCopy;
